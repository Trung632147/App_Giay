package com.manager.app_giay.Service;
...
import com.manager.app_giay.activity.MainActivity;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    private RemoteViews customView(String title, String body) {
        ...
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.ic_tb);
        return remoteViews;

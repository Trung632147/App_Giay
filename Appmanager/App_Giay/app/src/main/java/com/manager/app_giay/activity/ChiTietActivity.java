...
public class ChiTietActivity extends AppCompatActivity {
    ...
    private void themGioHang() {
        if(Utils.manggiohang.size() > 0){
            ...
            if(flag == false){
                ...
                gioHang.setTensp(sanPhamMoi.getTitle());
                gioHang.setHinhsp(sanPhamMoi.getThumbnail());
    ...
    private void initData() {
        ...
        tensp.setText(sanPhamMoi.getTitle());
        mota.setText(sanPhamMoi.getDescription());

        if(sanPhamMoi.getThumbnail().contains("http")){
            Glide.with(getApplicationContext()).load(sanPhamMoi.getThumbnail()).into(hinhanh);
        }else {
